...
class BiCycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN2', 'D', 'G_GAN2', 'G_L1', 'kl']
    ...
    def get_z_random(self, batch_size, nz, random_type='gauss'):
        if random_type == 'uni':
            ...
            z = torch.randn(batch_size, 8)* 2.0 - 1.0
    ...
    def test(self, z0=None, encode=False):
        with torch.no_grad():
            ...
            if z0 is None:
                z0t = self.get_z_random(self.real_A.size(0), 8)
                z0b = self.get_z_random(self.real_A.size(0), 8)
                z0h = self.get_z_random(self.real_A.size(0), 8)
                z0 = torch.cat((z0t, z0b, z0h), 1)
    ...
    def backward_EG(self):
        ...
        self.loss_G = self.loss_G_GAN2 + self.loss_G_L1
