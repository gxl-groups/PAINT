...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--phase', type=str, default='new_25-40_latest_val', help='train, val, test, etc')
        parser.add_argument('--num_test', type=int, default=1999, help='how many test images to run')
