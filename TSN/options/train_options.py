...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--display_port', type=int, default=1236, help='visdom display port')
        ...
        # lambda parameters
        parser.add_argument('--lambda_L1', type=float, default=20, help='weight for |B-G(A, E(B))|')
        ...
        parser.add_argument('--lambda_z', type=float, default=2, help='weight for ||E(G(random_z)) - random_z||')
        ...
        parser.add_argument('--use_same_D', action='store_true', default=False,
